...
import (
	...
	"github.com/influxdata/telegraf/internal/release"
...
func NewMetricDestination(opts *MetricDestConfig, logger telegraf.Logger) (*trapmetrics.TrapMetrics, error) {
	if ch == nil {
		return nil, fmt.Errorf("circonus metric destination management module: module not initialized")
	}
	if !ch.ready {
...
func updateCheckTags(client *apiclient.API, bundle *apiclient.CheckBundle, tags []string, logger telegraf.Logger) (*apiclient.CheckBundle, error) {
